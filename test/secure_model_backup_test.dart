...
void main() {
  ...
  test(
    ...
    () async {
      ...
      try {
        ...
        expect(jsonFile('manifest.json')['schemaVersion'], 14);
  ...
  test('backup ZIP rejects database and sync internal files', () async {
    ...
    for (final path in [
      ...
      'sync_applied_changes.json',
      'transport_change_heads.json',
      'transport_change_receipts.json',
      'transport_peer_acks.json',
