...
Cloud uploads require enrollment and Ed25519 signing. Managed relay requests use
one replayable authenticated streamed sender for a single refresh-and-retry on
401, including multipart uploads and streaming model responses.
